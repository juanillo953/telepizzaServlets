                                    ...
                                    <table width="100%" border="0">
                                        ...
                                        <tr>
                                            ...
                                            <td align="left" width="46%" class="centro">
                                                <h2>Postres</h2>
                                                <form action="ServletPostre" method="post">
                                                    <select name="postre" id="">
                                                        <option value="">-------</option>
                                            ...
                                            <td align="right" colspan="2">
                                                <h6>Bienvenido <%=usuario.getNombre()%><br>Usted ha accedido a nuestra zona de pedidos a las <%=hora%> del <%=fecha%></h6><img src="images/images_2016/postres.png" alt=""></td>
                                            <td width="7%" bgcolor="#FFFFFF"></td>
                                        </tr>
                                        <tr bgcolor="#990000">
                                            <td width="4%" bgcolor="#FFFFFF">&nbsp;</td>
